      ...
      >
        <div className="text-center space-y-4 mt-20">
          ...
          <h3 className="md:text-2xl text-xl text-white italic">
            Rent {FullCarDetails.data?.brand} {FullCarDetails.data?.model} Car
            Today - to make your dreams comes true
          </h3>
        </div>
      </PageBanner>
          ...
          <div className="content_area col-span-2 lg:pr-14">
            ...
            <div className="details mt-14">
              ...
              <ul className="grid  grid-cols-1 md:grid-cols-2 mt-10 gap-6 text-xl">
                <li>
                  <i className="fa-regular fa-copyright  bg-red-600 w-10 text-center py-2 mr-4  text-white"></i>
                  <strong>Brand :</strong> {FullCarDetails.data?.brand}
                </li>
                <li>
                  <i className="fa-regular fa-tag  bg-red-600 w-10 text-center py-2 mr-4 text-white"></i>
                  <strong>Model :</strong> {FullCarDetails.data?.model}
                </li>
                <li>
                  <i className="fa-regular fa-calendar-days  bg-red-600 w-10 text-center py-2 mr-4 text-white"></i>
                  <strong>Model Years : </strong>
                  {FullCarDetails.data?.modelYears}
                </li>
                <li>
                  <i className="fa-light fa-jug-bottle  bg-red-600 w-10 text-center py-2 mr-4 text-white"></i>
                  <strong>Fuel Type : </strong> {FullCarDetails.data?.fuelType}
                </li>
                <li>
                  <i className="fa-solid fa-key-skeleton-left-right  bg-red-600 w-10 text-center py-2 mr-4 text-white"></i>
                  <strong>Transmission Type : </strong>
                  {FullCarDetails.data?.transmissionType}
                </li>
              </ul>

              <p className=" mt-7 leading-8">
                {FullCarDetails.data?.description}
              </p>
